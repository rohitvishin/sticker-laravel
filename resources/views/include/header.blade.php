<header class="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
    <div class="flex items-center px-6 py-6 xl:px-24">
        ...
        <a href="index.html" class="shrink-0">
            <img src={{ asset('img/logo.png') }} class="max-h-7 dark:hidden" alt="STICKER MAJESTY" />
            <img src={{ asset('img/logo_white.png') }} class="hidden max-h-7 dark:block" alt="STICKER MAJESTY" />
        </a>

        <!-- Search -->
        <form action="" class="relative ml-12 mr-8 hidden basis-3/12 lg:block xl:ml-[8%]">
            <input type="search"

                ...
                <div class="lg:w-1/3 lg:pl-5">
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div>
                                <span class="block font-display text-base text-jacarta-700 dark:text-white"><a
...
$(document).ready(function() {
    $('#loginForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ url(' / login ') }}', // Replace with the correct login route
            type: 'POST',
            data: formData,
            ...
            success: function(response) {
                ...
                if (response.status === 1) {
                    ...
                    window.location.href =
                        '{{url(' /
                        home ')}}' // Replace with the desired URL after successful login
                } else {
                    // Login failed, show an error message or do something else
                    $('#loginMsg').html('Invalid credentials. Please try again.');
                }
            },
        });
    });
